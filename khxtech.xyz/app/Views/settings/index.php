    ...
    <form method="POST" action="/settings/save">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-currency-exchange"></i> Currency Management</h5>
                    </div>
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="/exchange-rates" class="btn btn-outline-primary">
                                <i class="bi bi-graph-up"></i> Exchange Rate Management
                            </a>
                            ...
                            <a href="/cashbox/currency-conversion" class="btn btn-outline-info">
                                <i class="bi bi-cash-stack"></i> Cashbox Currency Exchange
                            </a>
                            
                            <a href="/exchange-rates/report" class="btn btn-outline-secondary">
                                <i class="bi bi-file-earmark-text"></i> Exchange Rate Reports
                            </a>
                        </div>
                        
                        <small class="text-muted mt-2 d-block">
                            <i class="bi bi-info-circle"></i> 
                            Manage exchange rates, perform currency conversions, and generate reports.
                        </small>
                    </div>
                </div>
            </div>
