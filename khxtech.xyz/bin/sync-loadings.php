 ...
 * 
 * Add to crontab to run every 5 minutes (replace asterisk-slash-5 with proper cron syntax):
 * [asterisk]/5 [asterisk] [asterisk] [asterisk] [asterisk] /usr/bin/php /path/to/your/project/bin/sync-loadings.php --all >> /var/log/ababel-sync.log 2>&1
 * 
 * Add to crontab to retry failed syncs daily:
 * 0 2 [asterisk] [asterisk] [asterisk] /usr/bin/php /path/to/your/project/bin/sync-loadings.php --retry-failed >> /var/log/ababel-sync.log 2>&1
 */