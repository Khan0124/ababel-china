...
require_once BASE_PATH . '/app/Core/ErrorRecovery.php';

// Initialize error monitoring system
require_once BASE_PATH . '/app/Core/ErrorMonitor.php';
new \App\Core\ErrorMonitor();

// Load helper functions for PHP 8.3 compatibility
...
require_once BASE_PATH . '/app/Core/Security/CSRF.php';
\App\Core\Security\CSRF::init();
