                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="text-center mb-3"><?= htmlspecialchars($user['name']) ?></h6>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">
                                    ...
                                    <?= isset($user) ? __('users.activity_log') . ': ' . htmlspecialchars($user['name']) : __('users.activity_log') ?>
                                </h5>
                                <div>
                                    <!-- Filter Options -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="activity-timeline">
                                ...
                                <div class="activity-item" data-type="<?= htmlspecialchars($activity['type']) ?>" data-date="<?= $activity['created_at'] ?>">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                    ...
                                                    if (is_string($description) && (strpos($description, '{') === 0 || strpos($description, '[') === 0)) {
                                                        ...
                                                        if ($jsonData) {
                                                            if (isset($jsonData['description'])) {
                                                                echo htmlspecialchars($jsonData['description']);
                                                            } elseif (isset($jsonData['bol_number'])) {
                                                                echo "إصدار بوليصة الشحن: " . htmlspecialchars($jsonData['bol_number']);
                                                            } else {
                                                ...
                                                <div class="small text-muted">
                                                    ...
                                                    <br><i class="bi bi-device-hdd"></i> <?= htmlspecialchars($activity['user_agent']) ?>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="text-end">
