                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                <strong><?= __('users.username') ?>:</strong> <?= htmlspecialchars($user['username']) ?>
                            </div>
                            <div class="mb-2">
                                <strong><?= __('users.email') ?>:</strong> <?= htmlspecialchars($user['email']) ?>
                            </div>
                            <div class="mb-2">
                ...
                <div class="col-lg-<?= isset($user) ? '8' : '12' ?>">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">
                                <i class="bi bi-key"></i> 
                                <?= __('users.permissions') ?>: <?= htmlspecialchars($user['name']) ?>
                            </h5>
                        </div>
                        <div class="card-body">
