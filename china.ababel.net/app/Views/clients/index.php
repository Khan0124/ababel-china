                    ...
                    <table class="table table-hover" id="clients-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-<?= getBalanceType($client['balance_rmb']) == 'debt' ? 'danger' : 'success' ?>">
                                    <strong><?= formatBalance($client['balance_rmb'], 'RMB') ?></strong>
                                    <?php if (getBalanceType($client['balance_rmb']) == 'debt'): ?>
                                        <small class="d-block text-muted"><?= __('client_owes_company') ?></small>
                                    <?php elseif (getBalanceType($client['balance_rmb']) == 'credit'): ?>
                                        <small class="d-block text-muted"><?= __('company_owes_client') ?></small>
                                    <?php endif; ?>
                                </td>
                                <td class="text-<?= getBalanceType($client['balance_usd']) == 'debt' ? 'danger' : 'success' ?>">
                                    <strong><?= formatBalance($client['balance_usd'], 'USD') ?></strong>
                                    <?php if (getBalanceType($client['balance_usd']) == 'debt'): ?>
                                        <small class="d-block text-muted"><?= __('client_owes_company') ?></small>
                                    <?php elseif (getBalanceType($client['balance_usd']) == 'credit'): ?>
                                        <small class="d-block text-muted"><?= __('company_owes_client') ?></small>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button onclick="confirmDelete(<?= $client['id'] ?>, '<?= h($client['name'] ?? '') ?>')" 
