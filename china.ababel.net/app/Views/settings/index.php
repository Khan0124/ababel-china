    ...
    <form method="POST" action="/settings/save">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-currency-exchange"></i> <?= __('settings.currency_management') ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="/exchange-rates" class="btn btn-outline-primary">
                                <i class="bi bi-graph-up"></i> <?= __('settings.exchange_rate_management') ?>
                            </a>
                            
                            <a href="/exchange-rates/calculator" class="btn btn-outline-success">
                                <i class="bi bi-calculator"></i> <?= __('settings.currency_converter') ?>
                            </a>
                            
                            <a href="/cashbox/currency-conversion" class="btn btn-outline-info">
                                <i class="bi bi-cash-stack"></i> <?= __('settings.cashbox_currency_exchange') ?>
                            </a>
                            
                            <a href="/exchange-rates/report" class="btn btn-outline-secondary">
                                <i class="bi bi-file-earmark-text"></i> <?= __('settings.exchange_rate_reports') ?>
                            </a>
                        </div>
                        
                        <small class="text-muted mt-2 d-block">
                            <i class="bi bi-info-circle"></i> 
                            <?= __('settings.currency_management_description') ?>
                        </small>
                    </div>
                </div>
            </div>
