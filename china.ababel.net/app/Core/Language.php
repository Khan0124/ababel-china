...
class Language
{
    ...
    {
        // Use static cache to avoid reloading translations
        static $translationCache = [];
        
        if (isset($translationCache[$this->currentLang])) {
            $this->translations = $translationCache[$this->currentLang];
            return;
        }
        ...
        if (file_exists($langFile)) {
            ...
            $translationCache[$this->currentLang] = $this->translations;
        }
    }
