...
'notes' => 'ملاحظات',
    ...
    'messages' => [
        ...
        'error_issuing_bol' => 'خطأ في إصدار بوليصة الشحن. يرجى المحاولة مرة أخرى.',
        'bol_update_failed' => 'فشل تحديث بوليصة الشحن. يرجى المحاولة مرة أخرى.',
        'bol_update_success' => 'تم تحديث بوليصة الشحن بنجاح.',
        'loading_not_found' => 'التحميل غير موجود.',
        'loading_updated' => 'تم تحديث التحميل بنجاح.',
        'sync_in_progress' => 'جاري المزامنة مع نظام Port Sudan...',
        'sync_failed' => 'فشلت المزامنة',
        'loading_created_sync_failed' => 'تم إنشاء التحميل ولكن فشلت المزامنة',
        'invalid_client_code' => 'كود العميل غير صحيح. يرجى اختيار عميل صحيح.',
        'invalid_container_format' => 'تنسيق رقم الحاوية غير صحيح. يجب أن يكون 4 أحرف و 7 أرقام.',
        'loading_no_required' => 'رقم التحميل مطلوب.',
        'valid_client_required' => 'يرجى اختيار عميل صحيح من القائمة.',
        'transaction_approved_message' => 'تم اعتماد المعاملة',
        'cannot_delete_approved_transaction' => 'لا يمكن حذف معاملة معتمدة.',
        'error_approving_transaction' => 'خطأ في اعتماد المعاملة',
        'error_deleting_transaction' => 'خطأ في حذف المعاملة',
        'confirm_status_change' => 'هل أنت متأكد من تغيير الحالة؟',
    ],
