...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Export functionality moved to universal-export.js
    ...
    if (transactionForm) {
        transactionForm.addEventListener('submit', function(e) {
            ...
            submitBtn./* TODO: استخدم textContent أو insertAdjacentHTML */ innerHTML = '<span class="spinner-border spinner-border-sm"></span> جاري الحفظ...';
            ...
            .then(data => {
                if (data.success) {
                    ...
                    submitBtn./* TODO: استخدم textContent أو insertAdjacentHTML */ innerHTML = 'حفظ المعاملة';
                }
            })
            .catch(error => {
